...
(define op3 (option  1 "1) Pollo Frito" 4 1 "pollo" "ave" "frito"))
...
(define op6 (option 4 "4) No tengo hambre" 1 2 "volver" "no tengo hambre"))

(define op7 (option 1 "1) Conserje" 1 1 "conserje" "basura" "limpiar"))
(define op8 (option 2 "2) Taxista" 0 1 "taxi" "taxista" "conducir"))
(define op9 (option 3 "3) Camarero" 1 3 "camarero"))
(define op10 (option 4 "4) Ver más trabajos" 1 1 "más trabajo" "ver mas"))
(define op11 (option 5 "5) No quiero trabajar" 1 3 "no quiero trabajar" "atras"))

(define op12 (option 1 "1) Actor" 1 3 "actor" "actuacion" "teatro" "cine"))
(define op13 (option 2 "2) Cantante" 1 3 "cantar" "cantante"))
(define op14 (option 3 "3) Bailarín" 1 2 "bailar" "bailarin" "danzar" "moverse"))
(define op15 (option 4 "4) Futbolista" 1 1 "futbol" "futbolista" "messi" "cr7"))
(define op16 (option 5 "5) Trabajos anteriores" 1 1 "anteriores" "trabajos"))

(define op17 (option 1 "1) Profesional" 1 2 "profesional" "el mejor"))
(define op18 (option 2 "2) Experto" 1 2 "experto" "experimentado"))
(define op19 (option 3 "3) Principiante" 1 2 "principiante"))
(define op20 (option 4 "4) Amateur" 1 1 "amateur"))
(define op21 (option 5 "5) Otro trabajo" 1 1 "error" "otro"))
